...
============
*/
extern char *MK_cleanftos(float f);  // reduced config file
void Cvar_SetValue(char *var_name, float value)
{
    char	val[32];

    sprintf(val, "%s", MK_cleanftos(value));  // reduced config file
...
//Edited & Heffo - Cvar Callback Function - begin
...
//Edited & Heffo - Cvar Callback Function - end
/*
============
Cvar_Command
...
============
*/
qboolean HaveSemicolon(char *s);  // reduced config file
