...
#if defined(_M_IX86)
#define __i386__	0 //Edited keep zero!
#endif
...
#define id386	0 //Edited keep zero!
...
#define	MINIMUM_MEMORY			0x2000000 //0x550000  Edited 32Mb
...
#define	MAX_MSGLEN		32000 //Edited 8000		// max length of a reliable message
#define	MAX_DATAGRAM	32000 //Edited 1024		// max length of unreliable message
#define	DATAGRAM_MTU	1400 //Edited from fitzquake, if connected to server
//
// per-level limits
//
#define	MAX_EDICTS		8192			// was 600
#define	MAX_LIGHTSTYLES	64
#define	MAX_MODELS		2048	//Edited 256			// these are sent over the net as bytes
#define	MAX_SOUNDS		2048	//Edited 256		// so they cannot be blindly increased
