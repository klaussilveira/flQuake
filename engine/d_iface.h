...
//#define WARP_WIDTH		320 // hi-res waterwarp & buffered video - removed
//#define WARP_HEIGHT		200 // hi-res waterwarp & buffered video - removed
...
void D_PolysetDraw_C(void);  // transparencies
void D_PolysetDrawFinalVerts(finalvert_t *fv, int numverts);
void D_DrawParticle(particle_t *pparticle);
void D_DrawParticle_C(particle_t *pparticle); // enabled C particle renderer
void D_DrawParticle_A(particle_t *pparticle,float Alpha);
...
//extern byte				*r_skysource; // smooth sky - removed
...
//void R_GenTile (msurface_t *psurf, void *pdest); // removed
...
extern float	skyshift; // skyboxes
