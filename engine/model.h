...
#define SURF_DRAWSKYBOX		0x80		// skyboxes
#define SURF_DRAWTRANSLUCENT	0x100		// translucent water
...
typedef struct {
    ...
    trivertx_t			bboxmax;
    int					frame;
    int					numframes; // model interpolation
} maliasgroupframedesc_t;

typedef struct maliasgroup_s { // model interpolation - edited
    int						numframes;
    int						intervals;
