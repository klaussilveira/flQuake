...
#define QB_PROTOCOL  3773 //Edited
...
#define U_FRAMEINTERVAL	(1<<25) // QC frame_interval - be careful, as this uses the same number as U_COLORMOD
...
#define svc_letterbox		60	// svc_letterbox
#define svc_vibrate			61	// Edited
