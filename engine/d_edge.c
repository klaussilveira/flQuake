        ...
        for (s = &surfaces[1] ; s<surface_p ; s++) {
            ...
            if (s->flags & SURF_DRAWSKY) {
                ...
                */	// skyboxes - end
                ...
                if (!r_drawwater) { // translucent water
                    D_DrawZSpans(s->spans);
                }
            ...
            // skyboxes - begin
                ...
                extern pixel_t	r_skypixels[6][512*512]; // hi-res skyboxes - edited

                pface = s->data;
                miplevel = 0;
                cacheblock = (pixel_t*)&(((byte*)r_skypixels)[pface->texinfo->texture->offsets[0]]);
                cachewidth = pface->texinfo->texture->width; // hi-res skyboxes - edited
            ...
            // skyboxes - end
                ...
                cacheheight= pcurrentcache->height/sizeof(pixel_t);
